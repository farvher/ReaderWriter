...
public class Reader {
	...
	private void jbInit() {
		...
		label_9.setText("Access password:");
		...
		bt_close.setEnabled(false);//�ر�
		bt_power.setEnabled(false);//����
		bt_start.setEnabled(false);//��ʼ
		bt_stop.setEnabled(false);//ֹͣ
		bt_read.setEnabled(false);//��
		bt_write.setEnabled(false);//д
		...
		bt_Region.setText("Band setting");
	...
	protected void bt_open_actionPerformed(ActionEvent e) {
		...
		if(fCmdRet==0)
		{
			bt_close.setEnabled(true);//�ر�
			bt_open.setEnabled(false);//��
			bt_power.setEnabled(true);//����
			bt_start.setEnabled(true);//��ʼ
			bt_stop.setEnabled(true);//ֹͣ
			bt_read.setEnabled(true);//��
			bt_write.setEnabled(true);//д
	...
	protected void bt_power_actionPerformed(ActionEvent e) {
		...
		{
			JOptionPane.showMessageDialog(null,"�������óɹ�","��ʾ",JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	private boolean timeQyery=false;//��ʱ��ִ�б�־
	private boolean Qyeryflag=false;//����ѯ�������־
	...
	protected void bt_write_actionPerformed(ActionEvent e) {
        ...
        if(fCmdRet!=0){
        	JOptionPane.showMessageDialog(null,"д����ʧ��","��ʾ",JOptionPane.ERROR_MESSAGE);
        }
        else
        {
        	JOptionPane.showMessageDialog(null,"д���ݳɹ�","��ʾ",JOptionPane.ERROR_MESSAGE);
        }
	}
